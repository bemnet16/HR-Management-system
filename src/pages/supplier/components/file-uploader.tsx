  ...
  return (
    ...
    >
      ...
      {isDragActive ? (
        ...
        <div className="w-[100px] h-[100px] rounded-full border-2 border-dashed border-slate-400 flex justify-center items-center">
          <UserRound className="w-[80px] h-[80px]  text-slate-500"/>
