...
const PayrollCard = () => {
  return (
    <Link to="/payroll/1">
    <div className="w-fit h-16 bg-slate-400/10 rounded-xl flex gap-2 items-center">
      ...
      <div className="font-medium text-slate-700 text-center min-w-36">87</div>
      <div className="font-medium text-slate-700 text-center min-w-36">98</div>
